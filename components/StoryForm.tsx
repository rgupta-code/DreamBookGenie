...
const AGE_APPROPRIATE_IDEAS: Record<string, { story: string[], learning: string[] }> = {
  "Toddler (1-3 years)": {
    story: [
      "The Soft Blue Blanket", "Puppy's Big Day", "The Squeaky Mouse", "Happy Little Cloud", "Duckling's First Swim", "The Sleepy Bear", "Funny Red Ball", "Kitten's Secret Hideout", "The Playful Bunny", "Baby Elephant's Bath", "The Magic Bubbles", "Panda's Bamboo Breakfast", "The Brave Little Ant", "Monkey's Missing Banana", "The Singing Teapot", "Turtle's Shiny Shell", "The Dancing Butterfly", "Froggy's Big Jump", "The Friendly Dinosaur", "Lion's Gentle Roar", "The Little Red Tractor", "Squirrel's Acorn Hunt", "A Teddy Bear's Picnic", "The Sleepy Owl", "Penguin's Ice Slide", "The Happy Sunflower", "Bouncing Green Frog", "Brave Little Duck", "The Lost Mittens", "Dragon's Gentle Sneeze"
    ],
    learning: [
      "Red, Blue, and Yellow", "Big and Small", "Farm Animal Sounds", "The Happy Sun", "My Five Fingers", "Shapes All Around", "Counting 1 to 5", "Fruit Colors", "Wheels on the Bus", "Up and Down", "Fast and Slow", "Where is Nose?", "Hot and Cold", "Loud and Quiet", "Day and Night", "Happy and Sad", "Head, Shoulders, Knees", "Triangles and Circles", "Hello and Goodbye", "Sharing Toys", "Where Does Milk Come From?", "Animals That Say Moo", "Point to Your Nose", "The First ABCs", "Wiggle Your Toes", "What Colour is an Apple?", "The Moon and Stars", "Saying Please and Thank You", "Washing Our Hands", "The Happy Feelings"
    ]
  },
  "Preschool (3-5 years)": {
    story: [
      "The Dinosaur's Picnic", "The Girl Who Could Fly", "The Magic Treehouse", "Sharing the Big Apple", "A Cat that Speaks Spanish", "The Kingdom of Candy Clouds", "Detective Bunny's Case", "The Star in a Jar", "The Dragon Who Was Afraid of Fire", "The Runaway Pancake", "A Rocket Built of Cardboard", "The Monster Under the Bed Means No Harm", "Pirate Parrot's Treasure map", "The Boy Who Talked to Trees", "The Invisible Puppy", "Princess of the Sandbox", "The Moon's Birthday Party", "Super-Squirrel Saves the Day", "The Train to Sleepytown", "The Bear Who Wanted to Dance", "The Dinosaur Who Loved to Bake", "Pirate Bunny's Vegetable Map", "The Friendly Ghost's Tea Party", "A Trip to the Moon in a Box", "The Squirrel Who Forgot Where He Hid His Nuts", "The Cloud That Couldn't Rain", "The Talking Fire Engine", "Dragon's Missing Tooth", "The Mermaid Who Couldn't Swim", "The Grumpy Caterpillar"
    ],
    learning: [
      "The Life of a Bee", "How Rain Happens", "Why We Eat Veggies", "The 5 Senses", "Day and Night", "Under the Deep Sea", "Different Kinds of Trucks", "How Seeds Grow", "What Are Shadows?", "Why We Brush Our Teeth", "The Seasons of the Year", "Jobs People Do", "How Volcanoes Work", "Why the Sky is Blue", "Where Do Butterflies Go?", "How Airplanes Fly", "The Solar System", "Bugs in the Garden", "Where Milk Comes From", "How Our Bones Work", "Why Do We Need Sleep?", "How Do Plants Drink Water?", "What Are Clouds Made Of?", "The Lifecycle of a Frog", "How Do Fish Breathe?", "Why Do We Say Sorry?", "Identifying Shapes in the House", "Learning Right from Left", "What Do Doctors Do?", "How a Seed Becomes a Flower"
    ]
  },
  "School Age (5-8 years)": {
    story: [
      "Island of Mechanical Toys", "The Secret of the Whispering Woods", "Detective Bunny's Big Case", "The Time-Traveling Toaster", "A Giraffe with a Short Neck", "The Robot's Garden", "Brave Toaster's Forest Hike", "The Invisible Castle", "The Boy Who Painted Dreams", "The Magic Skateboard", "The Lost City of Atlantis", "The Pirate Who Only Stole Books", "The Ghost in the Grandfather Clock", "Journey to the Center of the Sandbox", "The Girl Who Befriended a Storm", "The Submarine Made of Glass", "Escape from the Candy Kingdom", "The Wizard's Lost Homework", "Alien Exchange Student", "The Lighthouse at the End of the World", "The Time-Traveling Backpack", "The Boy Who Built a Rocket in His Garage", "The Secret of the Whispering Cave", "The Robot Dinosaur's Great Escape", "The Magic Paintbrush That Drew Real Things", "A Case for the Treehouse Detectives", "The Island Where Toys Come Alive", "The Girl Who Tamed a Tornado", "The Mystery of the Missing Museum Diamond", "The Clockwork Owl"
    ],
    learning: [
      "How Volcanoes Erupt", "The Solar System Journey", "Ancient Egyptian Pyramids", "The Secret Life of Trees", "What is Gravity?", "How Electricity Works", "The Cycle of Water", "How Planes Fly", "The History of Chocolate", "How the Internet Works", "The Human Skeleton", "Why Do Leaves Change Color?", "How Magnets Work", "What Are Fossils?", "The History of Writing", "How Engines Work", "Photosynthesis Explained", "The Great Wall of China", "How Mountains Form", "The Discovery of Fire", "How Does the Ecosystem Work?", "The History of Ancient Rome", "Why Is the Ocean Salty?", "How Does the Human Heart Beat?", "What Causes Earthquakes?", "The Science of Rainbows", "How Do Compasses Work?", "The Discovery of Penicillin", "The Lifespan of a Star", "What are the States of Matter?"
    ]
  },
  "Pre-teen (9-12 years)": {
    story: [
      "The Quantum Library", "Lost in the Digital Maze", "The Last Starship to Earth", "Mystery of the Clockwork Kingdom", "The Girl with the Bio-Arm", "Escape from Paradox City", "The AI that Wrote a Poem", "Echoes of the Void", "The Boy Who Remembered Tomorrow", "City of Floating Islands", "The Chrono-Thief", "The Code-Breakers of Mars", "The Whisperer in the Data Stream", "Steampunk Rebellion", "The Omega Protocol", "Secrets of the Marianas Trench", "The Last Griffin rider", "A Glitch in Reality", "The Alchemist's Daughter", "Intergalactic Racing Circuit", "The Code-breakers of the Neon City", "Escape from Sector 7", "The Alchemist's Secret Formula", "Mystery of the Sunken Submarine", "The AI that Wanted to Be Human", "The Girl Who Could Speak to Machines", "The Last Ranger of the Wasteland", "The Time-Loop Paradox", "The Bio-Engineered Dragon", "The Hacker's Guide to the Galaxy"
    ],
    learning: [
      "Artificial Intelligence", "Deep Sea Creatures", "History of Video Games", "How DNA Works", "The Human Brain", "Black Holes Explained", "Renewable Energy", "The Renaissance", "The Industrial Revolution", "How Cryptography Works", "The Psychology of Habits", "The Space Race", "Quantum Physics Basics", "How Vaccines Work", "The Roman Empire", "Climate Change Solutions", "The History of Robotics", "Nanotechnology", "Understanding the Stock Market", "How Satellites Orbit", "The Basics of Cybersecurity", "How Quantum Computers Work", "The Science of Genetics and DNA", "What is Blockchain Technology?", "The Physics of Black Holes", "The History of the Cold War", "How the Human Immune System Works", "The Economics of Supply and Demand", "The Psychology of Memory", "The Space Telescope Discoveries"
    ]
  }
};
